function NCA_progress(action,varargin)
% Display progress and remaining time
% FORMAT NCA_progress('Init',n_iterations,process_name,iteration_name)
% Initialises progress tool
%
% FORMAT NCA_progress('Set',value)
% Sets iteration.
%
% FORMAT NCA_progress('Clear')
